(function() {
    ...
    angular
        .module('MainCtrl', [])
        .controller('MainController', ['$scope', '$mdBottomSheet','$mdSidenav', '$mdDialog', '$location', 'Dashboard', 'Sponsors', MainController]);
        ...
        function MainController($scope, $mdBottomSheet, $mdSidenav, $mdDialog, $location, Dashboard, Sponsors){
            ...
            $scope.title = "IT Production Dashboard";
        ...
        //        }
            ...
            $scope.showListBottomSheet = function($event) {
                $scope.alert = '';
                $mdBottomSheet.show({
                  template: '<md-bottom-sheet class="md-list md-has-header"> <md-subheader>Settings</md-subheader> <md-list> <md-list-item ng-repeat="item in items" md-ink-ripple flex class="inset"> <a flex aria-label="{{item.name}}" ng-click="listItemClick($index)"> <span class="md-inline-list-icon-label">{{ item.name }}</span> </a></md-list-item> </md-list></md-bottom-sheet>',
